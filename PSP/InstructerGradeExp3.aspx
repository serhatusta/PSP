<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterInstructer.Master" AutoEventWireup="true" CodeBehind="InstructerGradeExp3.aspx.cs" Inherits="PSP.InstructerGradeExp3" %>
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    <asp:Menu ID="Menu1" Width="155px" runat="server" Orientation="Vertical"
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Experiment-3" Value="3" ToolTip="Experiment-3" NavigateUrl="~/InstructerGradeExp3.aspx"  Selected="true"></asp:MenuItem>
