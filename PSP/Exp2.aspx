<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.Master" AutoEventWireup="true" CodeBehind="Exp2.aspx.cs" Inherits="PSP.Exp2" %>
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    <asp:Menu ID="Menu2" Width="155px" runat="server" Orientation="Vertical"
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Experiment-2" Value="2" ToolTip="Experiment-2" NavigateUrl="~/Exp2.aspx" Selected="true"></asp:MenuItem>
