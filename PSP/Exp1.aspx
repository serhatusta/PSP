<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.Master" AutoEventWireup="true" CodeBehind="Exp1.aspx.cs" Inherits="PSP.Exp1" %>
                            ...
                            <asp:TableCell>
                                <asp:Panel ID="Panel3" runat="server">
                                    <asp:Menu ID="Menu2" Width="155px" runat="server" Orientation="Vertical"
                                        ...
                                        <Items>
                                            <asp:MenuItem Text="Experiment-1" Value="1" ToolTip="Experiment-1" NavigateUrl="~/Exp1.aspx" Selected="true"></asp:MenuItem>
