<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterInstructer.Master" AutoEventWireup="true" CodeBehind="InstructerGradeExp5.aspx.cs" Inherits="PSP.InstructerGradeExp5" %>
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    <asp:Menu ID="Menu1" Width="155px" runat="server" Orientation="Vertical"
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Experiment-5" Value="5" ToolTip="Experiment-5" NavigateUrl="~/InstructerGradeExp5.aspx"  Selected="true"></asp:MenuItem>
