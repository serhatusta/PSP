...
namespace PSP
{
    public partial class InstructerAnnoucement : System.Web.UI.Page
    {
        ...
        public void loadAnnoucements(int gid)
        {
            anno_grid.DataSource = new Annoucement().Obj_Listele_All_By_Group(gid);
            anno_grid.DataBind();
        }
