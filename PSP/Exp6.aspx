<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.Master" AutoEventWireup="true" CodeBehind="Exp6.aspx.cs" Inherits="PSP.Exp6" %>
...
<%@ Register TagPrefix="Components" TagName="CodeReview" Src="~/Form/CodeReview.ascx" %>
<%@ Register TagPrefix="Components" TagName="DesignReview" Src="~/Form/DesignReview.ascx" %>
            ...
            <asp:TableCell Width="155px" >
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    <asp:Menu ID="Menu2" Width="155px" runat="server" Orientation="Vertical"
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Experiment-6" Value="6" ToolTip="Experiment-6" NavigateUrl="~/Exp6.aspx" Selected="true"></asp:MenuItem>
                                        </Items>
             ...
             <asp:TableCell Width="795px" VerticalAlign="Top">
                 <div style="border-left:solid #50647B;">
                     <asp:Panel ID="panel_forms" runat="server" Direction="LeftToRight" HorizontalAlign="Left">
