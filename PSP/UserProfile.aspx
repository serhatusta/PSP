<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="PSP.UserProfile" %>
...
font-size:18px;
width:940px;
font-style:italic";>User Profile</h3>
<br />
...
<asp:Panel runat="server" ID="panel_form" Width="300px" BorderWidth="1px">
    <asp:Table ID="Table1" runat="server" Width="300px"   HorizontalAlign="Center">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:TextBox runat="server" ID="text_company" Width="190px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
             <asp:TableCell>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:TextBox runat="server" ID="text_language" Width="190px"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        <asp:TableCell>
