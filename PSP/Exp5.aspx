<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterUser.Master" AutoEventWireup="true" CodeBehind="Exp5.aspx.cs" Inherits="PSP.Exp5" %>
                                ...
                                <asp:Panel ID="Panel3" runat="server">
                                    <asp:Menu ID="Menu2" Width="155px" runat="server" Orientation="Vertical"
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Experiment-5" Value="5" ToolTip="Experiment-5" NavigateUrl="~/Exp5.aspx" Selected="true"></asp:MenuItem>
